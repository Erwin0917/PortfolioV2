...
(0, _animations.headerTypingInit)();
...
exports.headerTypingInit = headerTypingInit;
...
function headerTypingInit() {
	$(".typing").typed({
		strings: ["Poszukiwania pracy na stanowisku Junior Front End ", "Nauka React", "Nauka j. Angielskiego"],
		smartBackspace: true,
		typeSpeed: 100,
		loop: true
